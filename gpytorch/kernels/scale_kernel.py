...
class ScaleKernel(Kernel):
    ...
    def prediction_strategy(self, train_inputs, train_prior_dist, train_labels, likelihood, jitter = None, cholJitter = None): # TODO added by DANNY (jitter)
        return self.base_kernel.prediction_strategy(train_inputs, train_prior_dist, train_labels, likelihood, jitter=jitter, cholJitter=cholJitter)
